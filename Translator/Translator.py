...
lab_txt = Label(root,text="Source Text",font=("Time New Romen", 15, "bold"), fg="Black")
...
lab_txt = Label(root,text="Dest Text",font=("Time New Romen", 15, "bold"), fg="Black")
